...
CASES = [
    ...
    ('sphere_boss',        synth.sphere_boss,                    'prismatic', None, 0.26),  # sphere region patched (hybrid); not yet analytic
    ('fillet_top',         synth.fillet_top,                     'faceted', None, None),   # edge fillets: not yet analytic
]
